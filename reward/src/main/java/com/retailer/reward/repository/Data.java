...
public class Data {
    public static List<Customer> customerList = Arrays.asList(
            new Customer(1, "Santosh", "(641) 451-3678", "santosh@gmail.com"),
            new Customer(2, "Customer 2", "(641) 451-3679", "santosh2@gmail.com"),
            new Customer(3, "Customer 3", "(641) 451-3670", "santosh3@gmail.com"),
            new Customer(4, "Customer 4", "(641) 451-3672", "santosh4@gmail.com"),
            new Customer(5, "Customer 5", "(641) 451-3673", "santosh5@gmail.com")
    );
    ...
    public static List<Transaction> transactionList = Arrays.asList(
            ...
            new Transaction(2, 1, LocalDate.of(2020, 2, 2), BigDecimal.valueOf(130)),
            new Transaction(3, 1, LocalDate.of(2020, 3, 3), BigDecimal.valueOf(220)),
            new Transaction(4, 1, LocalDate.of(2020, 3, 1), BigDecimal.valueOf(150)),
